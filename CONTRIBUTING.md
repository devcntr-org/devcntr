...
- Check existing [issues](https://github.com/the-dev-center/dev-center/issues) and [pull requests](https://github.com/the-dev-center/dev-center/pull-requests) to avoid duplicates.
- For larger changes, open an issue first to discuss approach.

## Development setup

- **Repo:** Clone from `https://github.com/the-dev-center/dev-center` (or your fork). Check the docs in `docs/modules/` for workspace and layout conventions.
...
- **Docs:** Documentation is in `docs/modules/` and built with [Antora](https://docs.antora.org/). Use AsciiDoc (`.adoc`). The published site is at <https://the-dev-center.github.io/docs>.
...
4. **Pull request** — Open a PR against `the-dev-center/dev-center` `main`. Describe what changed and why; reference any related issues.
...
- Open a [discussion](https://github.com/the-dev-center/dev-center/discussions) or an issue.
- For funding and sponsorship, see the [Sponsor](https://github.com/sponsors/the-dev-center) button and [.github/FUNDING.yml](.github/FUNDING.yml).
