...
In your main production playbook (e.g., `devcntr-app/docs/antora-playbook.yml`), you should use **Full GitHub URLs**. This is the only way for GitHub Actions to fetch all the pieces.

[source,yaml]
----
content:
  sources:
    - url: https://github.com/devcntr-app/msi-generator.git
      branches: HEAD
      start_path: docs
----
