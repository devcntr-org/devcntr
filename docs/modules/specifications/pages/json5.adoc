= JSON5 Endorsement
:description: Formal endorsement and specification for using JSON5 in DevCntr projects.
...
All projects within `devcntr-org` organization should prefer JSON5 for:
