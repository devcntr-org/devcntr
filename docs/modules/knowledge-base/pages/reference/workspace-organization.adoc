...
This document defines the standard structure for organizing local code repositories within the DevCntr ecosystem. This structure ensures a consistent, predictable environment for both developers and automated tools.
...
`Z:\code\github.com\devcntr-org\devcntr`
